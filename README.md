## JFrog DevOps on GCP Workshop

You can find this workshop here: [https://jfrogtraining.github.io/gcp-gke-workshop/](https://jfrogtraining.github.io/gcp-gke-workshop/).
...
This workshop walks you through a typical build, docker build and push, security scan and promotion process using Artifactory and Xray on Google cloud infrastructure using Google Kubernetes Engine and Google Cloud Build.
